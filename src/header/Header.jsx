    ...
    return (
        <header className="header">
            <nav className="nav container">
                {Toggle ? "" : <a href="/" className="nav__logo">Broadway Community</a>}

                <div ref={menuRef} className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
                    <ul className="nav__list grid">
                        <li className="nav__item">
                            <a href="/" value="#home" onClick={(e) => handleActiveNav(e)} className={activeNav === "#home" ? "nav__link active-link" : "nav__link"}>
                        ...
                        {!user ? (
                            <li className="nav__item">
                                <a href="login" value="#login" onClick={(e) => handleActiveNav(e)} className={activeNav === "#login" ? "nav__link active-link" : "nav__link"}>
                                    <i className="uil uil-user nav__icon"></i> Login
                                </a>
                            </li>
                        ) : (
                            <li className="nav__item">
                                <a href="/" value="#logout" onClick={logout} className={activeNav === "#logout" ? "nav__link active-link" : "nav__link"}>
